			...
			<script type="text/javascript">
				...
				function init() {
					...
					var mapOptions = {
						...
						center: new google.maps.LatLng(28.544012629763227, 77.33313729474987), // New York
			...
			<div class="col-md-4">
				...
				<div class="contact-info">
					<div>
						...
						<p><a href="tel:">888888 999994</a></p>
						<p>Cell Number</p>
					</div>
					<div>
						<i class="icon-mobile"></i>
						<p><a href="tel:">88888 222222</a></p>
						<p>Home Number</p>
					</div>
					<div>
						<i class="icon-mail-alt"></i>
						<p><a href="mailto:#">industryglobe@gmail.com</a></p>
					</div>
					<div>
						<i class="icon-skype"></i>
						<p><a href="#">industryglobe</a></p>
					</div>
				</div>
			</div>
		</div>
